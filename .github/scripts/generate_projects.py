...
Theme: matches the profile banner (Pink & Glitter Theme).
"""
import json, base64, os, sys, math, html
from datetime import datetime, timezone

# ---------------- themes ----------------
# Custom Pink & Glitter Theme 
THEMES = {
    "dark": {
        "BG": "#0A0A0A", "PANEL": "#120A16", "PANEL_BAR": "#180A22",
        "CYAN": "#FFB6C1", "VIOLET": "#FF69B4", "VIOLET2": "#D946EF",
        "EMERALD": "#EC4899", "TEXT": "#FDF2F8", "MUTED": "#F472B6",
        "DIM": "#831843",
        "STROKE": "rgba(255,105,180,0.3)", "STROKE_HI": "rgba(255,105,180,0.6)",
        "STROKE_LO": "rgba(255,105,180,0.15)", "BARLINE": "rgba(255,182,193,0.15)",
        "RING_BG": "rgba(255,105,180,0.15)", "PILL_BG": "rgba(217,70,239,0.2)",
        "PILL_STROKE": "rgba(217,70,239,0.5)", "MONO_TX": "#FFFFFF",
    },
    "light": {
        "BG": "#FDF2F8", "PANEL": "#FCE7F3", "PANEL_BAR": "#FBCFE8",
        "CYAN": "#BE185D", "VIOLET": "#9D174D", "VIOLET2": "#831843",
        "EMERALD": "#E11D48", "TEXT": "#4A0023", "MUTED": "#9D174D",
        "DIM": "#F472B6",
        "STROKE": "rgba(157,23,77,0.3)", "STROKE_HI": "rgba(157,23,77,0.6)",
        "STROKE_LO": "rgba(157,23,77,0.15)", "BARLINE": "rgba(157,23,77,0.15)",
        "RING_BG": "rgba(157,23,77,0.15)", "PILL_BG": "rgba(157,23,77,0.1)",
        "PILL_STROKE": "rgba(157,23,77,0.4)", "MONO_TX": "#FFFFFF",
    },
}
...
def set_theme(name):
    ...
    for k, v in t.items():
        g[k] = v
    # Shades of Pink and Magenta for the Language Donut Chart
    g["DONUT_COLORS"] = [t["VIOLET"], t["CYAN"], t["EMERALD"], "#D946EF", "#F472B6", "#9D174D"]
